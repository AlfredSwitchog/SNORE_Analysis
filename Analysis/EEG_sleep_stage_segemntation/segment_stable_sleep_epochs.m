...
%% ---------------- gBOLD ----------------
cfgGBOLD = struct( ...
    'signalDir',   '/Users/Richard/Masterabeit_local/SNORE_GM_Data/pre_processing/average_raw', ...
    'signalPat',   'gbold_p*_raw_average.mat', ...
    'signalVar',   'mean_signal', ...       % T x 1
    'signalCol',   1, ...
    'outBase',     '/Users/Richard/Masterabeit_local/SNORE_GM_Data/sleep_stage_segmented_raw_average', ...
    'outPrefix',   'gbold_');
