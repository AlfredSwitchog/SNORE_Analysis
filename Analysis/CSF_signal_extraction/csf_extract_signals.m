...
switch lower(env)
    case 'local'
        ...
        output_dir = '/Users/Richard/Masterabeit_local/SNORE_Analysis/Data/Raw';
...
participant_path_mask = fullfile(mask_dir, participant_id);
...
try
    ...
    %% === Load CSF mask ===
    mask_folder = fullfile(participant_path_mask, 'CSF_mask_pruning');
