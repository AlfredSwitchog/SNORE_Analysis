...
function r = cc_curve(g, c, lagsTR)
    ...
    for k = 1:numel(lagsTR)
        L = lagsTR(k);
        if L >= 0 % all parts of the Lag where csf signal artificalliy happens later then gBold, very crucial part!!!
